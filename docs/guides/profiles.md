...
| **셸** | 유틸리티 바 + GNB 64 + LNB 256 (`ggc-components.css` §9) | 스킵 링크 + 마스트헤드 + 헤더(유틸리티·브랜딩·주 메뉴) + 공개 푸터 + 아이덴티파이어 (`ggc-public.css`) |
| **본문 폭** | 1320 (대시보드) / 1360 | 1248 (KRDS contents 1200 + 24×2) |
| **컨트롤 높이** | 버튼 34/42/46 · 입력 44 | 버튼 40/48/56 · 입력 48 (KRDS size-height 6/7/8) |
| **글자** | 버튼·입력 13.5 · 라벨 13 · 표 13 | 17 · 17 · 17 (KRDS body/label medium) |
| **밀도** | 행 15×22 · 셀 11×10 · 카드 18×22 — 한 화면 15~20행 | 행 20×24 · 셀 12×16 · 카드 24 — 한 화면 8~12행 |
...
- 업무: `design/examples/dashboard.html` · `wizard.html` · `login.html`
